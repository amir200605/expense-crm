...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-2xl bg-muted p-1.5 text-muted-foreground gap-0.5",
      className
    )}
    {...props}
  />
